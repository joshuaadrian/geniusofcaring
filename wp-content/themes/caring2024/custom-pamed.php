...
<section class="video_container hd_on">
    ...
    <!-- Chapter One -->
    <div id="Chapter_One_Video" style="height:calc(100vh - 80px);position: relative;"><div style="position:absolute;inset:0;background:black;max-height: 100%;max-width:100%;"><iframe src="https://player.vimeo.com/video/1028145304?h=9595ab0dd9&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Pam &amp; Ed"></iframe></div></div><script src="https://player.vimeo.com/api/player.js"></script>
